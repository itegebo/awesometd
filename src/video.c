...
static const GLubyte charmap[256][32] =
{
    ...
    ['0'] = {
        0x00, 0, 0, 0, 0x38, 0, 0, 0, 0x64, 0, 0, 0, 0xc6, 0, 0, 0,
        0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0x4c, 0, 0, 0, 0x38, 0, 0, 0,
    },
    ['1'] = {
        0x00, 0, 0, 0, 0xfc, 0, 0, 0, 0x30, 0, 0, 0, 0x30, 0, 0, 0,
        0x30, 0, 0, 0, 0x30, 0, 0, 0, 0x70, 0, 0, 0, 0x30, 0, 0, 0,
    },
    ['2'] = {
        0x00, 0, 0, 0, 0xfe, 0, 0, 0, 0xe0, 0, 0, 0, 0x78, 0, 0, 0,
        0x3c, 0, 0, 0, 0x06, 0, 0, 0, 0xc6, 0, 0, 0, 0x7c, 0, 0, 0,
    },
    ['3'] = {
        0x00, 0, 0, 0, 0x7c, 0, 0, 0, 0xc6, 0, 0, 0, 0x06, 0, 0, 0,
        0x3c, 0, 0, 0, 0x18, 0, 0, 0, 0x0c, 0, 0, 0, 0x7e, 0, 0, 0,
    },
    ['4'] = {
        0x00, 0, 0, 0, 0x0c, 0, 0, 0, 0x0c, 0, 0, 0, 0xfe, 0, 0, 0,
    ...
    ['6'] = {
        0x00, 0, 0, 0, 0x7c, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
        0xfc, 0, 0, 0, 0xc0, 0, 0, 0, 0x60, 0, 0, 0, 0x3c, 0, 0, 0,
    },
    ['7'] = {
        0x00, 0, 0, 0, 0x30, 0, 0, 0, 0x30, 0, 0, 0, 0x30, 0, 0, 0,
    ...
    ['9'] = {
        0x00, 0, 0, 0, 0x78, 0, 0, 0, 0x0c, 0, 0, 0, 0x06, 0, 0, 0,
        0x7e, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0x7c, 0, 0, 0,
    },
    ['a'] = {
        0x00, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xfe, 0, 0, 0,
        0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0x6c, 0, 0, 0, 0x38, 0, 0, 0,
    },
    ['b'] = {
        0x00, 0, 0, 0, 0xfc, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
        0xfc, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xfc, 0, 0, 0,
    },
    ['c'] = {
        0x00, 0, 0, 0, 0x3c, 0, 0, 0, 0x66, 0, 0, 0, 0xc0, 0, 0, 0,
        0xc0, 0, 0, 0, 0xc0, 0, 0, 0, 0x66, 0, 0, 0, 0x3c, 0, 0, 0,
    },
    ['d'] = {
        0x00, 0, 0, 0, 0xf8, 0, 0, 0, 0xcc, 0, 0, 0, 0xc6, 0, 0, 0,
        0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xcc, 0, 0, 0, 0xf8, 0, 0, 0,
    },
    ['e'] = {
        0x00, 0, 0, 0, 0xfe, 0, 0, 0, 0xc0, 0, 0, 0, 0xc0, 0, 0, 0,
        0xfc, 0, 0, 0, 0xc0, 0, 0, 0, 0xc0, 0, 0, 0, 0xfe, 0, 0, 0,
    },
    ['f'] = {
        0x00, 0, 0, 0, 0xc0, 0, 0, 0, 0xc0, 0, 0, 0, 0xc0, 0, 0, 0,
        0xfc, 0, 0, 0, 0xc0, 0, 0, 0, 0xc0, 0, 0, 0, 0xfe, 0, 0, 0,
    },
    ['g'] = {
        0x00, 0, 0, 0, 0x3e, 0, 0, 0, 0x66, 0, 0, 0, 0xc6, 0, 0, 0,
        0xce, 0, 0, 0, 0xc0, 0, 0, 0, 0x60, 0, 0, 0, 0x3e, 0, 0, 0,
    },
    ['h'] = {
        0x00, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
        0xfe, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
    },
    ['i'] = {
        0x00, 0, 0, 0, 0x7e, 0, 0, 0, 0x18, 0, 0, 0, 0x18, 0, 0, 0,
    ...
    ['k'] = {
        0x00, 0, 0, 0, 0xce, 0, 0, 0, 0xdc, 0, 0, 0, 0xf8, 0, 0, 0,
    ...
    ['m'] = {
        0x00, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xd6, 0, 0, 0,
        0xfe, 0, 0, 0, 0xfe, 0, 0, 0, 0xee, 0, 0, 0, 0xc6, 0, 0, 0,
    },
    ['n'] = {
        0x00, 0, 0, 0, 0xc6, 0, 0, 0, 0xce, 0, 0, 0, 0xde, 0, 0, 0,
    ...
    ['p'] = {
        0x00, 0, 0, 0, 0xc0, 0, 0, 0, 0xc0, 0, 0, 0, 0xfc, 0, 0, 0,
        0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xfc, 0, 0, 0,
    },
    ['q'] = {
        0x00, 0, 0, 0, 0x7a, 0, 0, 0, 0xcc, 0, 0, 0, 0xde, 0, 0, 0,
        0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0x7c, 0, 0, 0,
    },
    ['r'] = {
        0x00, 0, 0, 0, 0xce, 0, 0, 0, 0xdc, 0, 0, 0, 0xf8, 0, 0, 0,
    ...
    ['t'] = {
        0x00, 0, 0, 0, 0x18, 0, 0, 0, 0x18, 0, 0, 0, 0x18, 0, 0, 0,
        0x18, 0, 0, 0, 0x18, 0, 0, 0, 0x18, 0, 0, 0, 0x7e, 0, 0, 0,
    },
    ['u'] = {
        0x00, 0, 0, 0, 0x7c, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
    ...
    ['v'] = {
        0x00, 0, 0, 0, 0x10, 0, 0, 0, 0x38, 0, 0, 0, 0x7c, 0, 0, 0,
        0xee, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
    },
    ['w'] = {
        0x00, 0, 0, 0, 0xc6, 0, 0, 0, 0xee, 0, 0, 0, 0xfe, 0, 0, 0,
        0xfe, 0, 0, 0, 0xd6, 0, 0, 0, 0xc6, 0, 0, 0, 0xc6, 0, 0, 0,
    },
    ['x'] = {
        0x00, 0, 0, 0, 0xc6, 0, 0, 0, 0xee, 0, 0, 0, 0x7c, 0, 0, 0,
    ...
    ['z'] = {
        0x00, 0, 0, 0, 0xfe, 0, 0, 0, 0xe0, 0, 0, 0, 0x70, 0, 0, 0,
...
static void vDrawTexturedQuad(float x, float y, float w, float h, float rot, float r, float g, float b, float a, GLuint id, int sid, int size)
{
    ...
    {
        tcoords[0] = 0.0+(0.25*(sid % 4));
        tcoords[1] = 0.0+(0.25*(sid / 4));
        tcoords[2] = 0.25+(0.25*(sid % 4));
        tcoords[3] = 0.0+(0.25*(sid / 4));
        tcoords[4] = 0.25+(0.25*(sid % 4));
        tcoords[5] = 0.25+(0.25*(sid / 4));
        tcoords[6] = 0.0+(0.25*(sid % 4));
        tcoords[7] = 0.25+(0.25*(sid / 4));
    }
    glColor4f(r,g,b,a);
